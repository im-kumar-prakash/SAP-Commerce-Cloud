 ...
 */
package com.nokia.core.constants;

/**
 * Global class for all NokiaCore constants. You can add global constants for your extension into this class.
 */
public final class NokiaCoreConstants extends GeneratedNokiaCoreConstants
{
	public static final String EXTENSIONNAME = "nokiacore";


	private NokiaCoreConstants()
	{
		//empty
	}
