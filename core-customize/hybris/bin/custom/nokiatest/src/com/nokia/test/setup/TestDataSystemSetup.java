...
import com.nokia.test.constants.NokiaTestConstants;
import com.nokia.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NokiaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/nokiatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/nokiatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/nokiatest/import/cstickets.impex");
			...
			importImpexFile(context, "/nokiatest/import/csquotes.impex");
		}
	}
}
