 ...
 */
package com.nokia.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NokiaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NokiaFulfilmentProcessConstants.PARENT_PROCESS);
