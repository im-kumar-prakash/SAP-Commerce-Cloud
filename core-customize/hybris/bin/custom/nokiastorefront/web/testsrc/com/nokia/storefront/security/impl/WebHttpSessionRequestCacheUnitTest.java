...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/nokiastorefront/electronics/en",
						"https://electronics.local:9002/nokiastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/nokiastorefront/electronics/en",
						"https://electronics.local:9002/nokiastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/nokiastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/nokiastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/nokiastorefront/electronics/en",
						"https://electronics.local:9002/nokiastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/nokiastorefront",
						"https://electronics.local:9002/nokiastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/nokiastorefront",
						"https://electronics.local:9002/nokiastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/nokiastorefront/electronics/en",
						"https://electronics.local:9002/nokiastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
